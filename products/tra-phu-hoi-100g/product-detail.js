...
function updateCartUI() {
    ...
    if (cart.length === 0) {
        ...
        cart.forEach(item => {
            ...
            // Tìm sản phẩm từ productsData để lấy thông tin chính xác
            const productInfo = productsData.find(p => p.id === item.id) || item;
            ...
            // Lấy ảnh từ productsData với đường dẫn đúng
            const imagePath = '../../' + (productInfo.image || 'src/Tra-phu-hoi-1.jpg');
            ...
            img.onerror = function() {
                ...
                this.src = '../../src/Hu-tra-phu-hoi.jpg';
            ...
            // Lấy giá từ productsData
            priceDiv.textContent = formatPrice(productInfo.price);
